...
$config['db_name'] = 'cw39500_inz';
$config['db_user'] = 'cw39500_inz';
$config['db_password'] = 'YMNxtFy8';
...
$config['http_host'] = 'siltis.ru';
$config['http_path'] = '';

// Host and directory where software is installed on secure server
$config['https_host'] = 'siltis.ru';
$config['https_path'] = '';
